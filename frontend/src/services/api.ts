...
export const assetsApi = {
  ...
  confirmUpload: (projectId: string, type: string, originalUrl: string, filename: string, durationMs?: number) =>
    api.post('/assets/confirm-upload', { projectId, type, originalUrl, filename, durationMs }).then(r => r.data),
